...
$(function () {
    ...
    var action = {
        ...
        dataTable: function () {
            ...
            var t = el.$jsTable.DataTable( {
                ...
                "columns": [
                    ...
                    {
                        "data": null,
                        "defaultContent": ' <a class="view" href="http://www.baidu.com" target="_blank">查看</a> <a class="hongchong">红冲</a> '
                    }
                ]
            });
        ...
        setForm0: function (data) {
            ...
            el.$jsForm0.find('input[name="hc_kpje"]').val(data.je);
