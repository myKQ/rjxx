    ...
    var action = {
        ...
        dataTable: function () {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            return '<a class="view" href="' + data.href+ '"  target="_blank">查看发票</a> <a class="modify" title="修改接收邮件地址和手机号码">修改</a> <a class="sent">发送</a>';
                        }
                    }
                ]
            });
            ...
            t.on( 'click', 'a.sent', function () {
                ...
                // todo set key
                _this.sentEmail({ids: data.id + ':' + row});
            });
            ...
            el.$jsForm1.validator({
                submit: function(e) {
                    ...
                    if (formValidity) {
                        ...
                        //row.data( d );
                        //el.$modalOriginalDetail.modal('close');  // show loading
                        //
                        //return false;
        ...
        setForm1: function (data) {
            ...
            el.$jsForm1.find('input[name="yx"]').val(data.yx);
            el.$jsForm1.find('input[name="sj"]').val(data.sj);
            el.$jsForm1.find('input[name="wx"]').val('这个还没有值'); // 你决定放什么
            el.$jsForm1.find('input[name="id"]').val(data.id);
